<?php
    ...
    <div class="tab_item" data-tabs="#abprf_orders">
        <h3 class="abp_color_theme_gap_xs">📋 Orders List</h3>
        ...
        <h6 class="abp_color_theme_gap_xs">🔎 Advanced Order Filtering System</h6>
        <label>
        ...
        <h6 class="abp_color_theme_gap_xs">📊 Order Management Features</h6>
        <ul class="abp_list_margin_xs">
        ...
        <h6 class="abp_color_theme_gap_xs">🗑️ Order Actions</h6>
        <ul class="abp_list_margin_xs">
            <li>
