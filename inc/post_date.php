<?php
    ...
    <div class="tab_item" data-tabs="#abprf_date">
        ...
        <h6 class="abp_color_theme_gap_xs">📅 Flexible Date Selection</h6>
        ...
        <h6 class="abp_color_theme_gap_xs">🌍 Global Date Configuration</h6>
        <i>
        ...
        <h6 class="abp_color_theme_gap_xs">⚙️ Smart Workflow Behavior</h6>
        <ul class="abp_list_margin_xs">
