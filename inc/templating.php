<?php
    ...
    <div class="tab_item" data-tabs="#abprf_template">
        ...
        <i class="_color_7_fs_label_mar_tb_d_block">
            To start customizing, copy the <strong>rf_templates</strong> folder from the RentalForge plugin directory and paste it into your <strong>wp-content</strong> directory. Once added, RentalForge will automatically load your custom templates instead of the default plugin templates.
        </i>
        <i class="_color_7_fs_label_mar_tb_d_block">
