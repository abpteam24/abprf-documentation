<?php
    ...
    <div class="tab_item" data-tabs="#abprf_email">
        ...
        <h2 class="_abprf_color_theme"><span class="_mar_r_xs">📧</span>RentalForge - E-Mail Configuration </h2>
        ...
        <table class="_abprf_fixed_text_left_mt">
            ...
            <tr>
                ...
                <td colspan="3">Should you wish to mail a traveler Turn the light <strong class="_abprf_color_theme"> ON</strong> . The mail won`t be sent if <strong class="_abprf_color_theme"> OFF</strong> . By default, <strong class="_abprf_color_theme"> ON</strong></td>
            </tr>
            <tr>
                <th class="_color_theme">Send pdf Ticket ?</th>
                <td colspan="3"> If you would like to email with PDF ticket, Turn <strong class="_abprf_color_theme"> ON</strong> otherwise the PDF won`t be sent if <strong class="_abprf_color_theme"> OFF</strong> . By default, <strong class="_abprf_color_theme"> ON</strong></td>
