<?php
	...
	<div class="tab_item" data-tabs="#abprf_create_order">
		...
		<i class="_color_light_3_fs_label_mar_tb_d_block">Clicking this page from the menu will only show the search form. Here you can select transport, boarding, dropping, journey date, return date. If you select transport then you won't get any information by selecting return date. It will work if you don't select transport.</i>
		<i class="_color_light_3_fs_label_mar_tb_d_block">If transport is selected and transport is seat type, this transport will look like above according to its configuration.</i>
		...
		<i class="_color_light_3_fs_label_mar_tb_d_block">If transport is selected and transport is ticket type, this transport will look like above according to its configuration.</i>
		...
		<i class="_color_light_3_fs_label_mar_tb_d_block">If transport is not selected then it will look like above. According to your information the transport list will show and return date input will work.</i>
		<i class="_color_light_3_fs_label_mar_tb_d_block">Clicking view ticket or view seat will show the details of that transport. From where the order can be confirmed by selecting ticket or seat select.</i>
