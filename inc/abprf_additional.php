<?php
	...
	<div class="tab_item" data-tabs="#abprf_additional_global">
		<h2 class="_abprf_color_theme">Configuration: Additional services </h2>
		<div class="_divider"></div>
		<i class="_color_7_fs_label_mar_tb_d_block">Here, you can create extra services that are either free or paid for and import them into any kind of transportation with ease. </i>
		<div class="_mar_tb" data-image-href="<?php echo esc_url( ABPRF_DOC_URL . '/' ) ?>image/5.3.additional_list.png"><img class="_img_control_reflex_6" src="#" alt="Additional services"></div>
