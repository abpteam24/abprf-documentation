<?php
	...
	<div class="tab_item" data-tabs="#abprf_configuration">
		<h2 class="_abprf_color_theme">TransportTicket - Bus, Ferry, Shuttle Booking : Global Configuration</h2>
		...
		<i class="_color_light_3_fs_label_mar_tb_d_block">You will see something similar to this page after activating the plugin. </i>
		<div class="_mar_t" data-image-href="<?php echo esc_url( ABPRF_DOC_URL . '/' ) ?>image/5.0.0.tools.png"><img class="_img_control_reflex_6" src="#" alt="Global Configuration"></div>
	</div>
<?php
