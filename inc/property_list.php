<?php
    ...
    <div class="tab_item" data-tabs="#abprf_properties">
        <h3 class="abp_color_theme">🏠 Properties List</h3>
        ...
        <h6 class="abp_color_theme_gap_xs">📋 Key Features of Property Management</h6>
        ...
        <h6 class="abp_color_theme_gap_xs">🔎 Advanced Filtering & Management</h6>
        <ul class="abp_list_margin_xs">
            <li>
        ...
        <h6 class="abp_color_theme_gap_xs">🧭 Post-wise Property Mapping</h6>
        <ul class="abp_list_margin_xs">
            <li>
        ...
        <h6 class="abp_color_theme_gap_xs">📄 Pagination & Performance</h6>
        <ul class="abp_list_margin_xs">
            <li>
