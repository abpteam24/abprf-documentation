<?php
    ...
    <div class="tab_item" data-tabs="#abprf_shortcode">
        <h2 class="abp_color_theme">RentalForge - Shortcodes</h2>
        ...
        <!-- Booking shortcode -->
        <pre>[<strong class="abp_color_theme">abprf-booking</strong>]</pre>
        <label>
        ...
        <table class="abp_mar_t">
            ...
            <tr>
                <td>style</td>
                <td> Layout style of the listing. <strong class="abp_color_theme">grid, list, masonry</strong> | Default: <strong class="abp_color_theme">grid</strong> <code>[abprf-booking style="list"]</code></td>
            </tr>
            <tr>
                <td>post_id</td>
            ...
            <tr>
                <td>rent_rule</td>
                <td> Filter by rental type: <strong class="abp_color_theme">hourly, daily, multi_day, monthly, multi_month</strong> <code>[abprf-booking rent_rule="daily"]</code></td>
            </tr>
            <tr>
                <td>show</td>
                <td> Number of posts to display. Default: <strong class="abp_color_theme">9</strong> <code>[abprf-booking show="12"]</code></td>
            </tr>
            <tr>
                <td>column</td>
                <td> Number of columns (only works with grid layout). Default: <strong class="abp_color_theme">3</strong> <code>[abprf-booking column="4"]</code></td>
            </tr>
            </tbody>
        </table>
        <!-- Post List shortcode -->
        <pre>[<strong class="abp_color_theme">abprf-post</strong>]</pre>
        <label>
        ...
        <table class="abp">
            ...
            <tr>
                ...
                <td>
                    ...
                    <strong class="abp_color_theme">hourly, daily, multi_day, monthly, multi_month</strong>
        ...
        <pre>[<strong class="abp_color_theme">abprf-property</strong>]</pre>
        <label>
        ...
        <table class="abp">
            ...
            <tr>
                ...
                <td>
                    Layout style.
                    <strong class="abp_color_theme">grid, list</strong> |
                    Default: <strong class="abp_color_theme">grid</strong>
        ...
        <!-- Gallery shortcode -->
        <pre>[<strong class="abp_color_theme">abprf-gallery</strong>]</pre>
        <label>
